...
GO
DELETE FROM [NZWalkDb].[dbo].[Difficulty];
GO
DELETE FROM [NZWalkDb].[dbo].[Walks];
GO
INSERT [dbo].[Difficulty] ([Id], [Name]) VALUES (N'f808ddcd-b5e5-4d80-b732-1ca523e48434', N'Hard')
GO
INSERT [dbo].[Difficulty] ([Id], [Name]) VALUES (N'54466f17-02af-48e7-8ed3-5a4a8bfacf6f', N'Easy')
GO
INSERT [dbo].[Difficulty] ([Id], [Name]) VALUES (N'ea294873-7a8c-4c0f-bfa7-a2eb492cbf8c', N'Medium')
GO
...
(Id, Name, Description, LengthInKm, WalkImageUrl, DiffucaltyId, RegionId)
values
...
(Id, Name, Description, LengthInKm, WalkImageUrl, DiffucaltyId, RegionId)
values
('f2b56c63-eb99-475a-881c-278f3da03e3d', 'The Kepler Track', 'One of New Zealand’s most famous walks, the Kepler Track offers stunning alpine vistas and takes you through a range of landscapes from peaceful beech forests to open tussock lands.', 32.0 , 'https://images.pexels.com/photos/2226900/pexels-photo-2226900.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', '54466f17-02af-48e7-8ed3-5a4a8bfacf6f','cfa06ed2-bf65-4b65-93ed-c9d286ddb0de');
GO
Insert into [NZWalkDb].[dbo].[Walks]
(Id, Name, Description, LengthInKm, WalkImageUrl, DiffucaltyId, RegionId)
values
('a7796ab6-5426-46af-b755-65d9b9e12978', 'The Hump Ridge Track', 'Experience the stunning scenery of the southern Fiordland and the coast on this challenging multi-day walk, with beautiful forest and alpine views.', 60.0 , 'https://images.pexels.com/photos/2226900/pexels-photo-2226900.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'f808ddcd-b5e5-4d80-b732-1ca523e48434','6884f7d7-ad1f-4101-8df3-7a6fa7387d81');
